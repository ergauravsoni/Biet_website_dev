...
admin.site.register(electronics_and_communication_research_scholars)
...
admin.site.register(cmca_dept_book_chapters)
...
admin.site.registerenvironmental_dept_timetable)
